angular.module('gridModule', ['levelServiceModule', 'rightClick'])
...
function gridController(levelService) {
  ...
  this.$routerOnActivate = function(next) {
    ...
    var level = levelService.getLevel(next.params.id);

    this.solution = level.grid;
